...
%%
%parpool(4)
%addpath('C:\\Users\\Aldan\\Documents\\kakau\\robotic-grasping-cornell\\dataset\\cornell')
...
for folder = 1:10
    ...
    imgDataDir = ['C:\\Users\\Aldan\\Documents\\kakau\\robotic-grasping-cornell\\dataset\\cornell' sprintf('%02d',folder)];
    txtDataDir = ['C:\\Users\\Aldan\\Documents\\kakau\\robotic-grasping-cornell\\dataset\\cornell' sprintf('%02d',folder)];   
    ...
    %mainfileID = fopen(['C:\\Users\\Aldan\\projects\\deepLearning\\deepGraspExtensiveOffline\\data\\grasps\\scripts\\trainttt' sprintf('%02d', folder) '.txt'],'a');
